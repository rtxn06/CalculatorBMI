...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonCalculate.setOnClickListener {
            calculateBMI(editTextHeight, editTextWeight, radioGroupGender,
                textViewResult, editTextName, editTextAddres)
        }
    ...
    private fun reset(
        editTextHeight: EditText, editTextWeight: EditText, textViewResult: TextView,
        editTextName: EditText, editTextAddres: EditText){
